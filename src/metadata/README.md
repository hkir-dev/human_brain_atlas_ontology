 ...
 * [hbao.yml](hbao.yml)
     * Determines how your purl.obolibrary.org/obo/hbao/ redirects will be handled
     ...
     * Paste in the contents of [hbao.yml](hbao.yml)
 ...
 * [hbao.md](hbao.md)
     ...
     * Paste in the contents of [hbao.md](hbao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
